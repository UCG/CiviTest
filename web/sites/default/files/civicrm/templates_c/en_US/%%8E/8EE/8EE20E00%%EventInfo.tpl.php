<?php /* Smarty version 2.6.31, created on 2021-08-23 20:30:22
         compiled from CRM/Event/Page/EventInfo.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Event/Page/EventInfo.tpl', 1, false),array('block', 'ts', 'CRM/Event/Page/EventInfo.tpl', 16, false),array('block', 'crmRegion', 'CRM/Event/Page/EventInfo.tpl', 80, false),array('function', 'crmURL', 'CRM/Event/Page/EventInfo.tpl', 35, false),array('modifier', 'replace', 'CRM/Event/Page/EventInfo.tpl', 56, false),array('modifier', 'escape', 'CRM/Event/Page/EventInfo.tpl', 83, false),array('modifier', 'purify', 'CRM/Event/Page/EventInfo.tpl', 92, false),array('modifier', 'crmDate', 'CRM/Event/Page/EventInfo.tpl', 105, false),array('modifier', 'date_format', 'CRM/Event/Page/EventInfo.tpl', 109, false),array('modifier', 'nl2br', 'CRM/Event/Page/EventInfo.tpl', 125, false),array('modifier', 'crmMoney', 'CRM/Event/Page/EventInfo.tpl', 194, false),)), $this); ?>
...
" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['registerText'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" class="button crm-register-button"><span><?php echo $this->_tpl_vars['registerText']; ?>
  ...
  <?php if ($this->_tpl_vars['event']['summary']): ?>
      <div class="crm-section event_summary-section">
        <?php echo ((is_array($_tmp=$this->_tpl_vars['event']['summary'])) ? $this->_run_mod_handler('purify', true, $_tmp) : smarty_modifier_purify($_tmp)); ?>

      </div>
  <?php endif; ?>
  <?php if ($this->_tpl_vars['event']['description']): ?>
      <div class="crm-section event_description-section summary">
          <?php echo ((is_array($_tmp=$this->_tpl_vars['event']['description'])) ? $this->_run_mod_handler('purify', true, $_tmp) : smarty_modifier_purify($_tmp)); ?>
  ...
  <div class="crm-section event_date_time-section">
      ...
      <div class="content">
        <?php echo ''; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['event']['event_start_date'])) ? $this->_run_mod_handler('crmDate', true, $_tmp) : smarty_modifier_crmDate($_tmp)); ?><?php echo ''; ?><?php if ($this->_tpl_vars['event']['event_end_date']): ?><?php echo '&nbsp;'; ?><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo 'through'; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php echo '&nbsp;'; ?><?php echo ''; ?><?php if (((is_array($_tmp=$this->_tpl_vars['event']['event_end_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y%m%d") : smarty_modifier_date_format($_tmp, "%Y%m%d")) == ((is_array($_tmp=$this->_tpl_vars['event']['event_start_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y%m%d") : smarty_modifier_date_format($_tmp, "%Y%m%d"))): ?><?php echo ''; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['event']['event_end_date'])) ? $this->_run_mod_handler('crmDate', true, $_tmp, 0, 1) : smarty_modifier_crmDate($_tmp, 0, 1)); ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['event']['event_end_date'])) ? $this->_run_mod_handler('crmDate', true, $_tmp) : smarty_modifier_crmDate($_tmp)); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?>
...
"><?php echo $this->_tpl_vars['email']['email']; ?>
  ...
  <?php if ($this->_tpl_vars['event']['is_monetary'] == 1 && $this->_tpl_vars['feeBlock']['value']): ?>
      <div class="crm-section event_fees-section">
          <div class="label"><?php echo $this->_tpl_vars['event']['fee_label']; ?>
</div>
          <div class="content">

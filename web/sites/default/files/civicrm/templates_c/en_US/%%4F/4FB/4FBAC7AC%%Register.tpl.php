<?php /* Smarty version 2.6.31, created on 2021-08-24 15:58:10
         compiled from CRM/Event/Form/Registration/Register.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Event/Form/Registration/Register.tpl', 1, false),array('block', 'ts', 'CRM/Event/Form/Registration/Register.tpl', 11, false),array('block', 'crmButton', 'CRM/Event/Form/Registration/Register.tpl', 12, false),array('block', 'crmRegion', 'CRM/Event/Form/Registration/Register.tpl', 36, false),array('function', 'crmURL', 'CRM/Event/Form/Registration/Register.tpl', 40, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if (call_user_func ( array ( 'CRM_Core_Permission' , 'check' ) , 'administer CiviCRM' )): ?>
  <?php ob_start(); ?><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Configure Event<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('buttonTitle', ob_get_contents());ob_end_clean(); ?>
  <?php $this->_tag_stack[] = array('crmButton', array('target' => '_blank','p' => "civicrm/event/manage/settings",'q' => "reset=1&action=update&id=".($this->_tpl_vars['event']['id']),'fb' => 1,'title' => ($this->_tpl_vars['buttonTitle']),'icon' => "fa-wrench")); $_block_repeat=true;smarty_block_crmButton($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Configure<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_crmButton($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
  <div class='clear'></div>
<?php endif; ?>
...
unset($_smarty_tpl_vars);
 ...
 crm-block crm-event-register-form-block">
    ...
    <?php $this->_tag_stack[] = array('crmRegion', array('name' => 'event-register-not-you-block')); $_block_repeat=true;smarty_block_crmRegion($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>

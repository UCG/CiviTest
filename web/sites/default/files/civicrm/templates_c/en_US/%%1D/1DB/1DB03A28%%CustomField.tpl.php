...
<?php if (! empty ( $this->_tpl_vars['element']['help_pre'] )): ?>
...
<?php endif; ?>
<?php if (isset ( $this->_tpl_vars['element']['options_per_line'] ) && $this->_tpl_vars['element']['options_per_line'] != 0): ?>
...
<?php if (! empty ( $this->_tpl_vars['element']['help_post'] )): ?><?php echo smarty_function_help(array('id' => $this->_tpl_vars['element']['id'],'file' => "CRM/Custom/Form/CustomField.hlp",'title' => $this->_tpl_vars['element']['label']), $this);?>
<?php endif; ?></td>

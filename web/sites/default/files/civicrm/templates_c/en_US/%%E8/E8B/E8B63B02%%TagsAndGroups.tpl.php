<?php /* Smarty version 2.6.31, created on 2021-08-24 17:18:10
...
<?php endif; ?>
    <table class="form-layout-compressed<?php if (isset ( $this->_tpl_vars['context'] ) && $this->_tpl_vars['context'] == 'profile'): ?> crm-profile-tagsandgroups<?php endif; ?>">
      <tr>
        <?php if (empty ( $this->_tpl_vars['type'] ) || $this->_tpl_vars['type'] == 'tag'): ?>
          <td>
...
<br><?php endif; ?>
            ...
            <?php if (! isset ( $this->_tpl_vars['context'] ) || $this->_tpl_vars['context'] != 'profile'): ?>
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <?php endif; ?>
        <?php if (empty ( $this->_tpl_vars['type'] ) || $this->_tpl_vars['type'] == 'group'): ?>
          <td>
            <?php if (isset ( $this->_tpl_vars['groupElementType'] ) && $this->_tpl_vars['groupElementType'] == 'select'): ?>
              <div class="crm-section group-section">
              <?php if (! empty ( $this->_tpl_vars['title'] )): ?><?php echo $this->_tpl_vars['form']['group']['label']; ?>
<br><?php endif; ?>
              <?php echo $this->_tpl_vars['form']['group']['html']; ?>

            </div>
            <?php else: ?>
              <?php if (isset ( $this->_tpl_vars['form']['group'] )): ?> 

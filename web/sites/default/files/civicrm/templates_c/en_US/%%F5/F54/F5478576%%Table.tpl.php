...
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if (empty ( $this->_tpl_vars['rows'] )): ?>
...
<?php else: ?>
    <?php if (! empty ( $this->_tpl_vars['pager'] ) && $this->_tpl_vars['pager']->_response && $this->_tpl_vars['pager']->_response['numPages'] > 1): ?>
...
?>
                ...
                <?php endif; ?>
                <?php if (empty ( $this->_tpl_vars['skip'] )): ?>
                   <?php if (! empty ( $this->_tpl_vars['header']['colspan'] )): ?>
...
><?php echo ((is_array($_tmp=$this->_tpl_vars['header']['title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
        ...
        <?php if (empty ( $this->_tpl_vars['sections'] )): ?>             <thead class="sticky">
            <tr>
...
<?php if ($this->_tpl_vars['header']['type'] == 1024 || $this->_tpl_vars['header']['type'] == 1 || $this->_tpl_vars['header']['type'] == 512): ?> report-contents-right<?php elseif ($this->_tpl_vars['row'][$this->_tpl_vars['field']] == 'Subtotal'): ?> report-label<?php endif; ?>">
                        <?php if (! empty ( $this->_tpl_vars['row'][$this->_tpl_vars['fieldLink']] )): ?>
...
"  <?php if (! empty ( $this->_tpl_vars['row'][$this->_tpl_vars['fieldClass']] )): ?> class="<?php echo $this->_tpl_vars['row'][$this->_tpl_vars['fieldClass']]; ?>
"<?php endif; ?>>
                        <?php endif; ?>
...
"><?php echo $this->_tpl_vars['fieldrow']; ?>
                        ...
                        <?php if (! empty ( $this->_tpl_vars['row'][$this->_tpl_vars['fieldLink']] )): ?></a><?php endif; ?>
                    </td>
                <?php endforeach; endif; unset($_from); ?>
            </tr>
        <?php endforeach; endif; unset($_from); ?>

        <?php if (! empty ( $this->_tpl_vars['grandStat'] )): ?>
                        <tr class="total-row">
                <?php $_from = $this->_tpl_vars['columnHeaders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['field'] => $this->_tpl_vars['header']):
?>

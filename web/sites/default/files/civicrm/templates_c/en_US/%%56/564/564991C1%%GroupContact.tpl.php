<?php /* Smarty version 2.6.31, created on 2021-08-24 17:37:39
...
<div class="form-item">
    <?php if (! empty ( $this->_tpl_vars['form']['group_id'] )): ?><?php echo $this->_tpl_vars['form']['group_id']['html']; ?>
<?php endif; ?> <?php if (! empty ( $this->_tpl_vars['form']['buttons'] )): ?><?php echo $this->_tpl_vars['form']['buttons']['html']; ?>
<?php endif; ?>

<?php /* Smarty version 2.6.31, created on 2021-08-24 17:47:41
         compiled from CRM/common/paymentBlock.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/common/paymentBlock.tpl', 1, false),array('modifier', 'json_encode', 'CRM/common/paymentBlock.tpl', 54, false),array('function', 'crmURL', 'CRM/common/paymentBlock.tpl', 104, false),)), $this); ?>
...
';
      ...
      var dataUrl = "<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/payment/form','h' => 0,'q' => "formName=".($this->_tpl_vars['form']['formName']).($this->_tpl_vars['urlPathVar']).($this->_tpl_vars['isBackOfficePathVar']).($this->_tpl_vars['profilePathVar']).($this->_tpl_vars['contributionPageID']).($this->_tpl_vars['preProfileID'])."processor_id="), $this);?>
" + type;
      <?php echo '

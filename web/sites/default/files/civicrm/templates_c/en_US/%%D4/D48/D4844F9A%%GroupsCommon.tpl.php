<?php /* Smarty version 2.6.31, created on 2021-08-24 20:40:10
...
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if (( isset ( $this->_tpl_vars['parent_groups'] ) && count($this->_tpl_vars['parent_groups']) > 0 ) || ! empty ( $this->_tpl_vars['form']['parents']['html'] )): ?>
  ...
  <?php if (isset ( $this->_tpl_vars['parent_groups'] ) && count($this->_tpl_vars['parent_groups']) > 0): ?>
...
<?php endif; ?>
<?php if (! empty ( $this->_tpl_vars['form']['organization_id'] )): ?>

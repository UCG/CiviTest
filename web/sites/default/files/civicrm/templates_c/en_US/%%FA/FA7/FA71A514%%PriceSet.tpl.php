    ...
    <?php if (call_user_func ( array ( 'CRM_Core_Permission' , 'check' ) , 'administer CiviCRM' )): ?>
      ...
      <?php if ($this->_tpl_vars['priceSet']['id'] && ! $this->_tpl_vars['priceSet']['is_quick_config']): ?>
        <div class='float-right'>
          <a class="crm-hover-button" target="_blank" href="<?php echo CRM_Utils_System::crmURL(array('p' => "civicrm/admin/price/field",'q' => "reset=1&action=browse&sid=".($this->_tpl_vars['priceSet']['id']),'fb' => 1), $this);?>
">
...
?>
                      <?php if (( $this->_tpl_vars['option']['tax_amount'] || $this->_tpl_vars['option']['tax_amount'] == '0' ) && $this->_tpl_vars['displayOpt'] && $this->_tpl_vars['invoicing']): ?>
                        ...
                        <?php elseif ($this->_tpl_vars['displayOpt'] == 'Inclusive'): ?>
                          ...
                          <span class='crm-price-amount-label'> <?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['taxTerm'],'2' => ((is_array($_tmp=$this->_tpl_vars['option']['tax_amount'])) ? $this->_run_mod_handler('crmMoney', true, $_tmp) : smarty_modifier_crmMoney($_tmp)))); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>(includes %1 of %2)<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span>
                        <?php else: ?>

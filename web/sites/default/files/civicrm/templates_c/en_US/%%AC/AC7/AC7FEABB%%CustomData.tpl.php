<?php /* Smarty version 2.6.31, created on 2021-08-24 21:30:45
...
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if (empty ( $this->_tpl_vars['isSingleRecordEdit'] ) && $this->_tpl_vars['cd_edit']['is_multiple'] == 1 && $this->_tpl_vars['cd_edit']['table_id'] && $this->_tpl_vars['contactId'] && ! $this->_tpl_vars['skipTitle'] && $this->_tpl_vars['cd_edit']['style'] == 'Inline'): ?>
...
<?php endif; ?>
<table <?php if (empty ( $this->_tpl_vars['isSingleRecordEdit'] )): ?>class="form-layout-compressed"<?php endif; ?>>
...
<?php if (empty ( $this->_tpl_vars['isSingleRecordEdit'] ) && $this->_tpl_vars['cd_edit']['is_multiple'] && ( ( $this->_tpl_vars['cd_edit']['max_multiple'] == '' ) || ( $this->_tpl_vars['cd_edit']['max_multiple'] > 0 && $this->_tpl_vars['cd_edit']['max_multiple'] > $this->_tpl_vars['cgCount'] ) )): ?>

<?php /* Smarty version 2.6.31, created on 2021-08-23 20:20:29
...
<div id="crm-container" class="crm-container<?php if (! empty ( $this->_tpl_vars['urlIsPublic'] )): ?> crm-public<?php endif; ?>" lang="<?php echo ((is_array($_tmp=$this->_tpl_vars['config']->lcMessages)) ? $this->_run_mod_handler('truncate', true, $_tmp, 2, "", true) : smarty_modifier_truncate($_tmp, 2, "", true)); ?>
...
<?php if (! empty ( $this->_tpl_vars['breadcrumb'] )): ?>
...
<?php if (! empty ( $this->_tpl_vars['pageTitle'] )): ?>
  <div class="crm-title">
    <h1 class="title"><?php if (! empty ( $this->_tpl_vars['isDeleted'] )): ?><del><?php endif; ?><?php echo $this->_tpl_vars['pageTitle']; ?>
<?php if (! empty ( $this->_tpl_vars['isDeleted'] )): ?></del><?php endif; ?></h1>
  </div>
<?php endif; ?>

<?php /* Smarty version 2.6.31, created on 2021-08-24 15:58:25
         compiled from CRM/Event/Form/Registration/Confirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Event/Form/Registration/Confirm.tpl', 1, false),array('block', 'ts', 'CRM/Event/Form/Registration/Confirm.tpl', 19, false),array('block', 'crmRegion', 'CRM/Event/Form/Registration/Confirm.tpl', 155, false),array('modifier', 'crmMoney', 'CRM/Event/Form/Registration/Confirm.tpl', 95, false),array('modifier', 'nl2br', 'CRM/Event/Form/Registration/Confirm.tpl', 148, false),array('modifier', 'truncate', 'CRM/Event/Form/Registration/Confirm.tpl', 163, false),array('modifier', 'crmDate', 'CRM/Event/Form/Registration/Confirm.tpl', 163, false),)), $this); ?>
...
&nbsp;&nbsp;<?php echo $this->_tpl_vars['amount']['label']; ?>
                ...
                <?php if ($this->_tpl_vars['totalTaxAmount']): ?>
                  ...
                  <div class="content bold"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Total <?php echo $this->_tpl_vars['taxTerm']; ?>
 Amount<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:&nbsp;&nbsp;<?php echo ((is_array($_tmp=$this->_tpl_vars['totalTaxAmount'])) ? $this->_run_mod_handler('crmMoney', true, $_tmp) : smarty_modifier_crmMoney($_tmp)); ?>
</div>
                  <div class="clear"></div>
                  </div>
                <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php if ($this->_tpl_vars['credit_card_type']): ?>
      <?php $this->_tag_stack[] = array('crmRegion', array('name' => "event-confirm-billing-block")); $_block_repeat=true;smarty_block_crmRegion($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>

<?php /* Smarty version 2.6.31, created on 2021-08-23 20:51:26
         compiled from CRM/Profile/Form/Dynamic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Profile/Form/Dynamic.tpl', 1, false),array('block', 'crmRegion', 'CRM/Profile/Form/Dynamic.tpl', 11, false),array('block', 'icon', 'CRM/Profile/Form/Dynamic.tpl', 17, false),array('block', 'ts', 'CRM/Profile/Form/Dynamic.tpl', 18, false),array('modifier', 'truncate', 'CRM/Profile/Form/Dynamic.tpl', 35, false),array('modifier', 'substr', 'CRM/Profile/Form/Dynamic.tpl', 136, false),array('modifier', 'cat', 'CRM/Profile/Form/Dynamic.tpl', 137, false),array('modifier', 'replace', 'CRM/Profile/Form/Dynamic.tpl', 154, false),)), $this); ?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo ''; ?><?php if ($this->_tpl_vars['isDuplicate']): ?><?php echo ''; ?><?php echo $this->_tpl_vars['form']['_qf_Edit_upload_duplicate']['html']; ?><?php echo ''; ?><?php endif; ?><?php echo '</div>'; ?><?php endif; ?><?php echo ''; ?><?php $this->assign('zeroField', 'Initial Non Existent Fieldset'); ?><?php echo ''; ?><?php $this->assign('fieldset', $this->_tpl_vars['zeroField']); ?><?php echo ''; ?><?php $_from = $this->_tpl_vars['fields']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):

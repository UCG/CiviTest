<?php /* Smarty version 2.6.31, created on 2021-08-25 21:08:33
         compiled from CRM/Contribute/Form/ContributionPage/Amount.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contribute/Form/ContributionPage/Amount.tpl', 1, false),array('block', 'crmRegion', 'CRM/Contribute/Form/ContributionPage/Amount.tpl', 11, false),array('block', 'ts', 'CRM/Contribute/Form/ContributionPage/Amount.tpl', 14, false),array('function', 'crmURL', 'CRM/Contribute/Form/ContributionPage/Amount.tpl', 10, false),array('function', 'docURL', 'CRM/Contribute/Form/ContributionPage/Amount.tpl', 14, false),array('modifier', 'crmAddClass', 'CRM/Contribute/Form/ContributionPage/Amount.tpl', 47, false),array('modifier', 'crmMoney', 'CRM/Contribute/Form/ContributionPage/Amount.tpl', 183, false),)), $this); ?>
...
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('ppUrl', ob_get_contents());ob_end_clean(); ?>
    ...
    <table class="form-layout-compressed">
        <tr class="crm-contribution-contributionpage-amount-form-block-is_monetary"><td scope="row" class="label" width="20%"><?php echo $this->_tpl_vars['form']['is_monetary']['label']; ?>
</td>
...
<br />
        ...
        <tr class="crm-contribution-contributionpage-amount-form-block-currency"><td scope="row" class="label" width="20%"><?php echo $this->_tpl_vars['form']['currency']['label']; ?>
</td>
...
<br />
        ...
        <?php if ($this->_tpl_vars['paymentProcessor']): ?>
          <tr class="crm-contribution-contributionpage-amount-form-block-payment_processor"><td scope="row" class="label" width="20%"><?php echo $this->_tpl_vars['form']['payment_processor']['label']; ?>
</td>
...
<br />
        ...
        <?php endif; ?>
        <tr class="crm-contribution-contributionpage-amount-form-block-is_pay_later"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['is_pay_later']['label']; ?>
</td>
...
<br />
        ...
        <tr id="payLaterFields" class="crm-contribution-form-block-payLaterFields"><td>&nbsp;</td>
            ...
            <table class="form-layout">
                <tr class="crm-contribution-contributionpage-amount-form-block-pay_later_text"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['pay_later_text']['label']; ?>
...
<br />
                ...
                <tr class="crm-contribution-contributionpage-amount-form-block-pay_later_receipt"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['pay_later_receipt']['label']; ?>
 <span class="crm-marker" title="This field is required.">*</span> <?php if ($this->_tpl_vars['action'] == 2): ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<br />
                ...
                <tr><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['is_billing_required']['label']; ?>
</td>
...
<br />
        ...
        <tr class="crm-contribution-contributionpage-amount-form-block-amount_block_is_active">
          <td scope="row" class="label"><?php echo $this->_tpl_vars['form']['amount_block_is_active']['label']; ?>
</td>
          <td><?php echo $this->_tpl_vars['form']['amount_block_is_active']['html']; ?>
<br />
          <span class="description"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Uncheck this box if you are using this contribution page for membership signup and renewal only &ndash; and you do NOT want users to select or enter any additional contribution amounts.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span></td>
        </tr>
        <tr id="priceSet" class="crm-contribution-contributionpage-amount-form-block-priceSet">
          <td scope="row" class="label"><?php echo $this->_tpl_vars['form']['price_set_id']['label']; ?>
</td>
...
<br /><span class="description"><?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['adminPriceSets'])); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Select a pre-configured Price Set to offer multiple individually priced options for contributions. Otherwise, select &quot;-none-&quot; and enter one or more fixed contribution options in the table below. Create or edit Price Sets <a href='%1'>here</a>.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span></td>
  ...
  <?php if ($this->_tpl_vars['recurringPaymentProcessor']): ?>
        <tr id="recurringContribution" class="crm-contribution-form-block-is_recur"><td scope="row" class="label" width="20%"><?php echo $this->_tpl_vars['form']['is_recur']['label']; ?>
</td>
...
<br />
        ...
        <tr id="recurFields" class="crm-contribution-form-block-recurFields"><td>&nbsp;</td>
               <td>
                  <table class="form-layout-compressed">
            <tr class="crm-contribution-form-block-recur_frequency_unit"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['recur_frequency_unit']['label']; ?>
<span class="crm-marker" title="This field is required.">*</span></td>
...
<br />
                    ...
                    <tr class="crm-contribution-form-block-is_recur_interval"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['is_recur_interval']['label']; ?>
</td>
...
<br />
                    ...
                    <tr class="crm-contribution-form-block-is_recur_installments"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['is_recur_installments']['label']; ?>
</td>
...
<?php if ($this->_tpl_vars['futurePaymentProcessor']): ?>
    <span id="pledge_calendar_date_field">&nbsp;&nbsp;<?php echo $this->_tpl_vars['form']['pledge_calendar_date']['html']; ?>
</span>
...
<?php endif; ?>
    ...
    <div id="amountFields">
        <table class="form-layout-compressed">
            ...
            <tr class="crm-contribution-form-block-is_pledge_active"><td scope="row" class="label" width="20%"><?php echo $this->_tpl_vars['form']['is_pledge_active']['label']; ?>
</td>
...
<br />
            ...
            <tr id="pledgeFields" class="crm-contribution-form-block-pledgeFields"><td></td><td>
                <table class="form-layout-compressed">
                    <tr class="crm-contribution-form-block-pledge_frequency_unit"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['pledge_frequency_unit']['label']; ?>
...
<br />
                    ...
                    <tr class="crm-contribution-form-block-is_pledge_interval"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['is_pledge_interval']['label']; ?>
</td>
...
<br />
                    ...
                    <tr class="crm-contribution-form-block-initial_reminder_day"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['initial_reminder_day']['label']; ?>
</td>
                    ...
                    <tr class="crm-contribution-form-block-max_reminders"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['max_reminders']['label']; ?>
</td>
                    ...
                    <tr class="crm-contribution-form-block-additional_reminder_day"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['additional_reminder_day']['label']; ?>
</td>
                ...
                <?php if ($this->_tpl_vars['futurePaymentProcessor']): ?>
                    <tr id="adjustRecurringFields" class="crm-contribution-form-block-adjust_recur_start_date"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['adjust_recur_start_date']['label']; ?>
</td>
...
&nbsp;<?php echo $this->_tpl_vars['form']['is_pledge_start_date_editable']['label']; ?>
      ...
      <tr class="crm-contribution-form-block-amount_label">
              <td scope="row" class="label" width="20%"><?php echo $this->_tpl_vars['form']['amount_label']['label']; ?>
<span class="crm-marker"> *</span></td>
        <td><?php echo $this->_tpl_vars['form']['amount_label']['html']; ?>
</td>
      </tr>
            <tr class="crm-contribution-form-block-is_allow_other_amount"><td scope="row" class="label" width="20%"><?php echo $this->_tpl_vars['form']['is_allow_other_amount']['label']; ?>
</td>
...
<br />
            ...
            <tr id="minMaxFields" class="crm-contribution-form-block-minMaxFields"><td>&nbsp;</td><td>
               <table class="form-layout-compressed">
                <tr class="crm-contribution-form-block-min_amount"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['min_amount']['label']; ?>
</td>
                <td><?php echo $this->_tpl_vars['form']['min_amount']['html']; ?>
</td></tr>
                <tr class="crm-contribution-form-block-max_amount"><td scope="row" class="label"><?php echo $this->_tpl_vars['form']['max_amount']['label']; ?>
</td>
                <td><?php echo $this->_tpl_vars['form']['max_amount']['html']; ?>
<br />
...
</td><td><?php echo $this->_tpl_vars['form']['value'][$this->_tpl_vars['idx']]['html']; ?>

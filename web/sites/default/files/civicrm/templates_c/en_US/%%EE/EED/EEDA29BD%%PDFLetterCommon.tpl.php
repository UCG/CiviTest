<?php /* Smarty version 2.6.31, created on 2021-08-24 17:36:22
         compiled from CRM/Contact/Form/Task/PDFLetterCommon.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Form/Task/PDFLetterCommon.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Form/Task/PDFLetterCommon.tpl', 19, false),array('function', 'help', 'CRM/Contact/Form/Task/PDFLetterCommon.tpl', 16, false),array('function', 'crmURL', 'CRM/Contact/Form/Task/PDFLetterCommon.tpl', 236, false),array('modifier', 'crmAddClass', 'CRM/Contact/Form/Task/PDFLetterCommon.tpl', 113, false),)), $this); ?>
...
<div class="crm-accordion-wrapper collapsed crm-pdf-format-accordion">
    <div class="crm-accordion-header">
      <?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Page Format:<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?> <span class="pdf-format-header-label"></span>
    </div>
 ...
 <?php echo smarty_function_help(array('id' => "id-pdf-format",'file' => "CRM/Contact/Form/Task/PDFLetterCommon.hlp"), $this);?>
      ...
      <tr>
        <td><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Width x Height<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td><td id="paper_dimensions">&nbsp;</td>
        <td colspan="2">&nbsp;</td>
      </tr>
      <tr>

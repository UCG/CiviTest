<?php /* Smarty version 2.6.31, created on 2021-08-24 18:59:51
...
?>
        <?php $this->assign('filterCount', count($this->_tpl_vars['table'])); ?>
                <?php if (! empty ( $this->_tpl_vars['filterGroups'][$this->_tpl_vars['tableName']]['group_title'] ) && $this->_tpl_vars['filterCount'] >= 1): ?>
...
unset($_smarty_tpl_vars);
 ?>
                ...
                <?php elseif ($this->_tpl_vars['form'][$this->_tpl_vars['fieldOp']]['html']): ?>
                  <tr class="report-contents crm-report crm-report-criteria-filter crm-report-criteria-filter-<?php echo $this->_tpl_vars['tableName']; ?>
" <?php if (! empty ( $this->_tpl_vars['field']['no_display'] )): ?> style="display: none;"<?php endif; ?>>
                    <td class="label report-contents"><?php if (! empty ( $this->_tpl_vars['field']['title'] )): ?><?php echo $this->_tpl_vars['field']['title']; ?>
<?php endif; ?></td>
...
_max_cell">
                        <?php if (! empty ( $this->_tpl_vars['form'][$this->_tpl_vars['filterMin']] )): ?><?php echo $this->_tpl_vars['form'][$this->_tpl_vars['filterMin']]['label']; ?>
&nbsp;<?php echo $this->_tpl_vars['form'][$this->_tpl_vars['filterMin']]['html']; ?>
&nbsp;&nbsp;<?php endif; ?>
                        <?php if (! empty ( $this->_tpl_vars['form'][$this->_tpl_vars['filterMax']] )): ?><?php echo $this->_tpl_vars['form'][$this->_tpl_vars['filterMax']]['label']; ?>
...
<?php endif; ?>
        ...
        <?php if (! empty ( $this->_tpl_vars['filterGroups'][$this->_tpl_vars['tableName']]['group_title'] )): ?>
              </table>

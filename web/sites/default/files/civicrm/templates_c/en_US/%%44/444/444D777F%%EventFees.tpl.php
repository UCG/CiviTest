...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Event/Form/EventFees.tpl', 1, false),array('block', 'ts', 'CRM/Event/Form/EventFees.tpl', 16, false),array('modifier', 'crmMoney', 'CRM/Event/Form/EventFees.tpl', 29, false),array('modifier', 'crmAddClass', 'CRM/Event/Form/EventFees.tpl', 115, false),array('function', 'crmURL', 'CRM/Event/Form/EventFees.tpl', 35, false),array('function', 'help', 'CRM/Event/Form/EventFees.tpl', 80, false),)), $this); ?>
...
<?php ob_start(); ?><?php if ($this->_tpl_vars['action'] != 2): ?>1<?php else: ?>0<?php endif; ?><?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('isShowBillingBlock', ob_get_contents());ob_end_clean(); ?>
...
unset($_smarty_tpl_vars);
 ?></td>
    ...
    <?php if ($this->_tpl_vars['accessContribution'] && ! $this->_tpl_vars['participantMode'] && ( $this->_tpl_vars['action'] != 2 || ! $this->_tpl_vars['rows']['0']['contribution_id'] || $this->_tpl_vars['onlinePendingContributionId'] ) && $this->_tpl_vars['isRecordPayment'] && ! $this->_tpl_vars['registeredByParticipantId']): ?>
      <?php $this->assign('isShowBillingBlock', true); ?>
...
</td><td><?php echo $this->_tpl_vars['form']['total_amount']['html']; ?>
</td></tr>
                <tr>
...
<?php if ($this->_tpl_vars['isShowBillingBlock']): ?>

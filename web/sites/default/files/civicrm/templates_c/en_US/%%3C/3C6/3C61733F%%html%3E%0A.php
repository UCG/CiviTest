...
<center>
  ...
  <tr>
   <td>
    {assign var="greeting" value="Dear Tory"}{if $greeting}<p>{$greeting},</p>{/if}
...
', 25, false),array('modifier', 'crmDate', 'string:<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
 <title></title>
...
', 39, false),array('modifier', 'nl2br', 'string:<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
 <title></title>
...
<center>
  ...
  <tr>
   <td>
    <?php $this->assign('greeting', 'Dear Tory'); ?><?php if ($this->_tpl_vars['greeting']): ?><p><?php echo $this->_tpl_vars['greeting']; ?>
,</p><?php endif; ?>
...
>
     ...
     <?php if ($this->_tpl_vars['isShowLocation']): ?>
      <tr>
       <td colspan="2" <?php echo $this->_tpl_vars['valueStyle']; ?>
>
        <?php echo ((is_array($_tmp=$this->_tpl_vars['event']['location']['address']['1']['display'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>

...
" title="<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>view current employer<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"><?php echo $this->_tpl_vars['current_employer']; ?>
      ...
      <div class="crm-summary-row">
        ...
        <div class="crm-content crm-contact-job_title"><?php if (isset ( $this->_tpl_vars['job_title'] )): ?><?php echo $this->_tpl_vars['job_title']; ?>
<?php endif; ?></div>
      </div>
      <?php endif; ?>
      <div class="crm-summary-row">
        ...
        <div class="crm-content crm-contact-nick_name"><?php if (isset ( $this->_tpl_vars['nick_name'] )): ?><?php echo $this->_tpl_vars['nick_name']; ?>
<?php endif; ?></div>
      </div>
      ...
      <div class="crm-summary-row">
        ...
        <div class="crm-content crm-contact-legal_name"><?php if (isset ( $this->_tpl_vars['legal_name'] )): ?><?php echo $this->_tpl_vars['legal_name']; ?>
<?php endif; ?></div>
      </div>
      <div class="crm-summary-row">
        ...
        <div class="crm-content crm-contact-sic_code"><?php if (isset ( $this->_tpl_vars['sic_code'] )): ?><?php echo $this->_tpl_vars['sic_code']; ?>
<?php endif; ?></div>
      </div>
      <?php endif; ?>
      <div class="crm-summary-row">
        ...
        <div class="crm-content crm-contact_source"><?php if (isset ( $this->_tpl_vars['source'] )): ?><?php echo $this->_tpl_vars['source']; ?>
<?php endif; ?></div>
      </div>

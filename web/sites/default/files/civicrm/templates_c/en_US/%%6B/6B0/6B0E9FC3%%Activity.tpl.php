<?php /* Smarty version 2.6.31, created on 2021-08-24 17:35:13
...
'<?php endif; ?>?</div>
  ...
  <?php if (! empty ( $this->_tpl_vars['form']['separation'] )): ?>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_edit($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
  ...
  <?php if (! empty ( $this->_tpl_vars['activityTypeFile'] )): ?>
...
unset($_smarty_tpl_vars);
 ?>
  ...
  <?php endif; ?>
  <?php if (! empty ( $this->_tpl_vars['form']['tag']['html'] )): ?>
  ...
  <?php if (! empty ( $this->_tpl_vars['tagsetInfo']['activity'] )): ?>

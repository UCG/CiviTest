<?php /* Smarty version 2.6.31, created on 2021-08-25 21:23:44
         compiled from CRM/Contribute/Form/Contribution/ThankYou.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contribute/Form/Contribution/ThankYou.tpl', 1, false),array('block', 'ts', 'CRM/Contribute/Form/Contribution/ThankYou.tpl', 43, false),array('block', 'crmRegion', 'CRM/Contribute/Form/Contribution/ThankYou.tpl', 121, false),array('modifier', 'escape', 'CRM/Contribute/Form/Contribution/ThankYou.tpl', 26, false),array('modifier', 'crmMoney', 'CRM/Contribute/Form/Contribution/ThankYou.tpl', 91, false),array('modifier', 'crmDate', 'CRM/Contribute/Form/Contribution/ThankYou.tpl', 109, false),array('modifier', 'count', 'CRM/Contribute/Form/Contribution/ThankYou.tpl', 184, false),array('modifier', 'nl2br', 'CRM/Contribute/Form/Contribution/ThankYou.tpl', 248, false),array('modifier', 'truncate', 'CRM/Contribute/Form/Contribution/ThankYou.tpl', 286, false),array('function', 'crmURL', 'CRM/Contribute/Form/Contribution/ThankYou.tpl', 308, false),)), $this); ?>
...
" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['friendText'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" class="button"><span><i class="crm-i fa-chevron-right" aria-hidden="true"></i> <?php echo $this->_tpl_vars['friendText']; ?>
</span></a>
...
" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['linkText'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" class="button"><span><i class="crm-i fa-chevron-right" aria-hidden="true"></i> <?php echo $this->_tpl_vars['linkText']; ?>
</span></a>
    </div><br /><br />
  <?php endif; ?>
  ...
  <div class="help">
      ...
      <?php endif; ?>
    <?php elseif ($this->_tpl_vars['isPendingOutcome']): ?>
      <div><?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['paymentProcessor']['name'])); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Your contribution has been submitted to %1 for processing.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></div>
        <?php if ($this->_tpl_vars['is_email_receipt']): ?>
      <div>
        <?php if ($this->_tpl_vars['onBehalfEmail'] && ( $this->_tpl_vars['onBehalfEmail'] != $this->_tpl_vars['email'] )): ?>
    ...
    <?php endif; ?>
  <?php else: ?>
    <div><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Your transaction has been processed successfully.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></div>
      <?php if ($this->_tpl_vars['is_email_receipt']): ?>
        <div>
          <?php if ($this->_tpl_vars['onBehalfEmail'] && ( $this->_tpl_vars['onBehalfEmail'] != $this->_tpl_vars['email'] )): ?>
...
<?php if ($this->_tpl_vars['amount_level']): ?> &ndash; <?php echo $this->_tpl_vars['amount_level']; ?>
<?php endif; ?></strong>
          <?php endif; ?>
        <?php endif; ?>
            ...
            <?php $this->_tag_stack[] = array('crmRegion', array('name' => "contribution-thankyou-recur")); $_block_repeat=true;smarty_block_crmRegion($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
              <?php if ($this->_tpl_vars['installments'] > 1): ?>
                ...
                <?php else: ?>
                  ...
                  <?php else: ?>
                                        <?php if ($this->_tpl_vars['frequency_unit'] == 'day'): ?>
                      <p><strong><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>This contribution will be automatically processed every day.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></strong></p>
                    <?php elseif ($this->_tpl_vars['frequency_unit'] == 'week'): ?>
                      <p><strong><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>This contribution will be automatically processed every week.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></strong></p>
                    <?php elseif ($this->_tpl_vars['frequency_unit'] == 'month'): ?>
                      <p><strong><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>This contribution will be automatically processed every month.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></strong></p>
                    <?php elseif ($this->_tpl_vars['frequency_unit'] == 'year'): ?>
                      <p><strong><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>This contribution will be automatically processed every year.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></strong></p>
                    <?php endif; ?>
                  <?php endif; ?>
                <?php endif; ?>
                  <p>

<?php /* Smarty version 2.6.31, created on 2021-08-24 15:58:38
         compiled from CRM/Event/Form/Registration/ThankYou.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Event/Form/Registration/ThankYou.tpl', 1, false),array('block', 'ts', 'CRM/Event/Form/Registration/ThankYou.tpl', 43, false),array('block', 'crmRegion', 'CRM/Event/Form/Registration/ThankYou.tpl', 176, false),array('modifier', 'escape', 'CRM/Event/Form/Registration/ThankYou.tpl', 29, false),array('modifier', 'crmMoney', 'CRM/Event/Form/Registration/ThankYou.tpl', 91, false),array('modifier', 'crmDate', 'CRM/Event/Form/Registration/ThankYou.tpl', 116, false),array('modifier', 'nl2br', 'CRM/Event/Form/Registration/ThankYou.tpl', 169, false),array('modifier', 'truncate', 'CRM/Event/Form/Registration/ThankYou.tpl', 184, false),array('function', 'crmURL', 'CRM/Event/Form/Registration/ThankYou.tpl', 198, false),)), $this); ?>
...
" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['pcpLinkText'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" class="button"><span><i class="crm-i fa-chevron-right" aria-hidden="true"></i> <?php echo $this->_tpl_vars['pcpLinkText']; ?>
</span></a>
        </div><br /><br />
    <?php endif; ?>
    ...
    <div class="help">
        ...
        <?php elseif ($this->_tpl_vars['is_pay_later'] && $this->_tpl_vars['paidEvent'] && ! $this->_tpl_vars['isAmountzero']): ?>
            ...
            <p><?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['paymentProcessor']['name'])); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Your registration payment has been submitted to %1 for processing.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></p>
            <?php if ($this->_tpl_vars['is_email_confirm']): ?>
            ...
            <?php endif; ?>
        <?php else: ?>
            <p><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Your registration has been processed successfully.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></p>
            <?php if ($this->_tpl_vars['is_email_confirm']): ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php if ($this->_tpl_vars['credit_card_type']): ?>
      <?php $this->_tag_stack[] = array('crmRegion', array('name' => "event-thankyou-billing-block")); $_block_repeat=true;smarty_block_crmRegion($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>

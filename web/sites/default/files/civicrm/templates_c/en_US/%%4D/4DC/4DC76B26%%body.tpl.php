...
<?php if (( $this->_tpl_vars['snippet'] !== 'json' ) && empty ( $this->_tpl_vars['suppressForm'] ) && count ( $this->_tpl_vars['form']['errors'] ) > 0): ?>
...
<?php if (! empty ( $this->_tpl_vars['beginHookFormElements'] )): ?>

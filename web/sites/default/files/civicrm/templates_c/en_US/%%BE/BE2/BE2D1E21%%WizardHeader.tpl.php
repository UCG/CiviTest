<?php /* Smarty version 2.6.31, created on 2021-08-25 20:52:55
         compiled from CRM/common/WizardHeader.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/common/WizardHeader.tpl', 1, false),array('block', 'ts', 'CRM/common/WizardHeader.tpl', 56, false),array('modifier', 'crmFirstWord', 'CRM/common/WizardHeader.tpl', 17, false),array('modifier', 'cat', 'CRM/common/WizardHeader.tpl', 30, false),)), $this); ?>
...
<div id="wizard-steps">
   <ul class="wizard-bar<?php if (! empty ( $this->_tpl_vars['wizard']['style']['barClass'] )): ?>-<?php echo $this->_tpl_vars['wizard']['style']['barClass']; ?>
<?php endif; ?>">
...
?>
        ...
        <?php endif; ?>
                <?php if (empty ( $this->_tpl_vars['wizard']['steps'][$this->_sections['step']['index']]['collapsed'] ) && ! empty ( $this->_tpl_vars['wizard']['steps'][$this->_sections['step']['index']]['name'] ) && $this->_tpl_vars['wizard']['steps'][$this->_sections['step']['index']]['name'] != 'Submit' && $this->_tpl_vars['wizard']['steps'][$this->_sections['step']['index']]['name'] != 'PartnerSubmit'): ?>
...
<?php if (! empty ( $this->_tpl_vars['wizard']['style']['showTitle'] )): ?>

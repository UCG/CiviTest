 ...
 ?></div>
  <table class="form-layout">
    <tr class="crm-preferences-display-form-block-contact_view_options">
      ...
      <td><ul class="crm-checkbox-list"><li><?php echo $this->_tpl_vars['form']['contact_view_options']['html']; ?>
</li></ul></td>
    </tr>
...
-contactedit">
                    <?php echo $this->_tpl_vars['form']['contact_edit_options'][$this->_tpl_vars['opId']]['html']; ?>
...
-contactedit">
    ...
    <tr class="crm-preferences-display-form-block-advanced_search_options">
      ...
      <td><ul class="crm-checkbox-list"><li><?php echo $this->_tpl_vars['form']['advanced_search_options']['html']; ?>
</li></ul></td>
    </tr>
    <tr class="crm-preferences-display-form-block-description">
      <td>&nbsp;</td>
...
"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('dedupeRules', ob_get_contents());ob_end_clean(); ?>
    ...
    <tr class="crm-preferences-display-form-block-user_dashboard_options">
      ...
      <td>
        <ul class="crm-checkbox-list"><li>
          <?php echo $this->_tpl_vars['form']['user_dashboard_options']['html']; ?>

          <span style="position: absolute; right: 5px; bottom: 3px;"> <?php echo smarty_function_help(array('id' => "id-invoices_id"), $this);?>
</span>
        </li></ul>
      </td>
    </tr>
 ...
 <?php echo smarty_function_help(array('id' => 'editor_id'), $this);?>
    ...
    <tr class="crm-preferences-display-form-block_menubar_position">
      <td class="label"><?php echo $this->_tpl_vars['form']['menubar_position']['label']; ?>
</td>
      <td>
        <?php echo $this->_tpl_vars['form']['menubar_position']['html']; ?>

        <div class="description"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Default position for the CiviCRM menubar.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></div>
      </td>
    </tr>
    <tr class="crm-preferences-display-form-block_menubar_color">
      <td class="label"><?php echo $this->_tpl_vars['form']['menubar_color']['label']; ?>
</td>
      <td>
        <?php echo $this->_tpl_vars['form']['menubar_color']['html']; ?>

      </td>
    </tr>
    <tr class="crm-preferences-display-form-block-theme_backend">
      <td class="label"><?php echo $this->_tpl_vars['form']['theme_backend']['label']; ?>
 <?php echo smarty_function_help(array('id' => 'theme_backend'), $this);?>
</td>
      <td><?php echo $this->_tpl_vars['form']['theme_backend']['html']; ?>
</td>
    </tr>
    <tr class="crm-preferences-display-form-block-theme_frontend">
      <td class="label"><?php echo $this->_tpl_vars['form']['theme_frontend']['label']; ?>
 <?php echo smarty_function_help(array('id' => 'theme_frontend'), $this);?>
</td>
      <td><?php echo $this->_tpl_vars['form']['theme_frontend']['html']; ?>
</td>
    </tr>
  </table>
  <div class="crm-submit-buttons"><?php $_smarty_tpl_vars = $this->_tpl_vars;

<?php /* Smarty version 2.6.31, created on 2021-08-25 20:57:24
         compiled from CRM/Contribute/Form/ContributionPage/Settings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contribute/Form/ContributionPage/Settings.tpl', 1, false),array('block', 'crmRegion', 'CRM/Contribute/Form/ContributionPage/Settings.tpl', 11, false),array('block', 'ts', 'CRM/Contribute/Form/ContributionPage/Settings.tpl', 14, false),array('function', 'help', 'CRM/Contribute/Form/ContributionPage/Settings.tpl', 31, false),array('function', 'crmURL', 'CRM/Contribute/Form/ContributionPage/Settings.tpl', 45, false),array('function', 'crmAPI', 'CRM/Contribute/Form/ContributionPage/Settings.tpl', 107, false),)), $this); ?>
...
<br/>
            <span class="description"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>This title will be displayed at the top of the page unless the frontend title field is filled out.<br />Please use only alphanumeric, spaces, hyphens and dashes for Title.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
  </tr>
  <tr class="crm-contribution-contributionpage-settings-form-block-frontend-title"><td class="label"><?php echo $this->_tpl_vars['form']['contribution_page_frontend_title']['label']; ?>
 <?php if ($this->_tpl_vars['action'] == 2): ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'CRM/Core/I18n/Dialog.tpl', 'smarty_include_vars' => array('table' => 'civicrm_contribution_page','field' => 'frontend_title','id' => $this->_tpl_vars['contributionPageID'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php endif; ?></td><td><?php echo $this->_tpl_vars['form']['contribution_page_frontend_title']['html']; ?>
<br/>
...
unset($_smarty_tpl_vars);
 ...
 <?php echo smarty_function_help(array('id' => "id-start_date"), $this);?>
  ...
  <tr class="crm-contribution-contributionpage-settings-form-block-end_date">
      ...
      <td><?php echo $this->_tpl_vars['form']['end_date']['html']; ?>
</td>
    </tr>

<?php /* Smarty version 2.6.31, created on 2021-08-23 20:28:14
         compiled from CRM/Admin/Form/Options.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Admin/Form/Options.tpl', 1, false),array('block', 'icon', 'CRM/Admin/Form/Options.tpl', 15, false),array('block', 'ts', 'CRM/Admin/Form/Options.tpl', 16, false),)), $this); ?>
...
<br />
        ...
        <?php elseif (! empty ( $this->_tpl_vars['form']['label'] )): ?>
...
<br />
     ...
     <?php if (! empty ( $this->_tpl_vars['form']['financial_account_id']['html'] )): ?>
     ...
     <?php endif; ?>
      ...
      <?php if (! empty ( $this->_tpl_vars['form']['value']['html'] ) && $this->_tpl_vars['gName'] != 'redaction_rule'): ?>
...
<br />
          ...
          <?php endif; ?>
            <?php if (! empty ( $this->_tpl_vars['form']['name']['html'] )): ?>               <tr class="crm-admin-options-form-block-name">
...
<br />
            ...
            <?php endif; ?>
            <?php if (! empty ( $this->_tpl_vars['form']['filter']['html'] )): ?>               <tr class="crm-admin-options-form-block-filter">
...
<br />
        ...
        <?php endif; ?>
        <?php if (! empty ( $this->_tpl_vars['form']['grouping']['html'] )): ?>
          <tr class="crm-admin-options-form-block-grouping">
        ...
        <?php endif; ?>
        <?php if (! empty ( $this->_tpl_vars['form']['weight'] )): ?>
        ...
        <?php endif; ?>
        <?php if (! empty ( $this->_tpl_vars['form']['icon']['html'] )): ?>
        ...
        <?php endif; ?>
        <?php if (! empty ( $this->_tpl_vars['form']['color']['html'] )): ?>
        ...
        <?php endif; ?>
        <?php if (! empty ( $this->_tpl_vars['form']['component_id']['html'] )): ?>               <tr class="crm-admin-options-form-block-component_id">
        ...
        <?php if (! empty ( $this->_tpl_vars['showDefault'] )): ?>
        ...
        <?php endif; ?>
        <?php if (! empty ( $this->_tpl_vars['showContactFilter'] )): ?>           <tr class="crm-admin-options-form-block-contactOptions">

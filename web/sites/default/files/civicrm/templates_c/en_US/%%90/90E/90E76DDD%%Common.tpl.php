...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contribute/Form/Search/Common.tpl', 1, false),array('block', 'ts', 'CRM/Contribute/Form/Search/Common.tpl', 15, false),array('modifier', 'crmAddClass', 'CRM/Contribute/Form/Search/Common.tpl', 26, false),array('function', 'help', 'CRM/Contribute/Form/Search/Common.tpl', 90, false),)), $this); ?>
 ...
 <?php echo smarty_function_help(array('id' => "is-test",'file' => "CRM/Contact/Form/Search/Advanced"), $this);?>
  ...
  <td>
    <table style="width:auto">
      ...
      <tr>
        <td><?php echo $this->_tpl_vars['form']['is_template']['label']; ?>
 <?php echo smarty_function_help(array('id' => "is-template",'file' => "CRM/Contact/Form/Search/Advanced"), $this);?>
</td>
        <td>
          <?php echo $this->_tpl_vars['form']['is_template']['html']; ?>
...
<tr>
  ...
  <td>
    <label><?php echo $this->_tpl_vars['form']['contribution_page_id']['label']; ?>
</label> <br />
...
<tr>
  <td><label><?php echo $this->_tpl_vars['form']['contribution_id']['label']; ?>
</label> <?php echo $this->_tpl_vars['form']['contribution_id']['html']; ?>
</td>
</tr>
...
<?php if (! empty ( $this->_tpl_vars['contributionGroupTree'] )): ?>
<tr>
  <td colspan="2">
  <?php $_smarty_tpl_vars = $this->_tpl_vars;
